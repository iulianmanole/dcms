<?php
/**
 * Will perform the same functions as Zend_Paginator
 * Additionally, will allow to create custom interactions with paginated data.
 * 
 */
class Inno_Paginator_Extended
{
	/**
	...
	/**
	 * Unique Identifier for this paginator.
	 */
	protected $_name = '';
	/**
	 * Instance of Zend_Paginator
	 */
	 ...
	 */
	protected $_formName = 'forms_PaginatorMultiCheckBox';
	 ...
	 * 				display a message
	 * 		- paginatorView will not be initialized 
	 *
	 */
	...
	{
		if (null === $this->_paginatorView) {
			$this->_paginatorView = new Inno_Paginator_Extended_View($this);
		}
	 ...
	 * @return Inno_Paginator_Extended_View 
	 */
	public function setPaginatorView(Inno_Paginator_Extended_View $paginatorView)
	{
		$this->_paginatorView = $paginatorView; 
	...
	public function setName($name)
	{
		if ($name !== null) {
			...
			throw new Zend_Paginator_Exception('Paginator name can\'t be null. Please specify pagiantor\'s name.');
		}
	}
	...
	{
		return $this->getPaginatorView()->render();
	}
